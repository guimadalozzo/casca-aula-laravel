...
<script>
	$(document).ready(function(){
		...
		x++;
		var newField = '<div><div style="width:94%; float:left" id="habito">{!! Form::select("itens[]", \App\Habito::orderBy("nome")->pluck("nome","id")->toArray(), null, ["class"=>"form-control", "required", "placeholder"=>"Selecione um hábito"]) !!}</div><button type="button" class="remove_field btn btn-danger btn-circle"><i class="fa fa-times"></button></div>';
